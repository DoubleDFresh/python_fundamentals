"""
Milestone 2:  Determine if the variable acts like a container or a label
...
b = 2
print('these variables act as containers - each variable contains its own data')
...
h[1] *= 100
print()
print('Variables below act as labels - more than one variable refers to same object')
